...
b = JOIN a BY School_Code LEFT, grads_prep BY School_Code USING 'replicated';
c = JOIN b BY School_Code LEFT, eval_prep BY Org_Code USING 'replicated';
d = JOIN c BY School_Name LEFT, cs_prep BY SCHOOL USING 'replicated';
e = JOIN d BY School_Code LEFT, enrollment BY ORG_CODE USING 'replicated';
DUMP e;