...
case $filename in
    ...
    "Employee_Earnings"*)
        echo "CREATE TABLE IF NOT EXISTS '$filename' ( ${params[0]} string, ${params[1]} string, ${params[2]} string, ${params[3]} string, ${params[4]} string, ${params[5]} string, ${params[6]} string, ${params[7]} string, ${params[8]} string, ${params[9]} string, ${params[10]} string, ${params[11]} int ) \
    ...
    "EducatorEval"*)
        echo "CREATE TABLE IF NOT EXISTS '$filename' ( ${params[0]} string, ${params[1]} int, ${params[2]} int, ${params[3]} float, ${params[4]} float, ${params[5]} float, ${params[6]} float, ${params[7]} float, ${params[8]} float ) \
        COMMENT ‘Location and Administrative info for Boston Public Schools’ \
        ROW FORMAT DELIMITED \
        FIELDS TERMINATED BY ‘,’ \
        LINES TERMINATED BY ‘\n’ \
    ...
    "Gradsattendingcollege"*)
        echo "CREATE TABLE IF NOT EXISTS '$filename' ( ${params[0]} string, ${params[1]} int, ${params[2]} int, ${params[3]} int, ${params[4]} float, ${params[5]} float, ${params[6]} float, ${params[7]} float, ${params[8]} float, ${params[9]} float, ${params[10]} float, ${params[11]} float ) \
        COMMENT ‘Location and Administrative info for Boston Public Schools’ \
        ROW FORMAT DELIMITED \
        FIELDS TERMINATED BY ‘,’ \
        LINES TERMINATED BY ‘\n’ \
    ...
    "Non_Public"*)
        echo "CREATE TABLE IF NOT EXISTS '$filename' ( ${params[0]} double, ${params[1]} double, ${params[2]} int, ${params[3]} int, ${params[4]} int, ${params[5]} string, ${params[6]} string, ${params[7]} string, ${params[8]} string, ${params[9]} string, ${params[10]} string, ${params[11]} string, ${params[12]} string, ${params[13]} string, ${params[14]} string, ${params[15]} string ) \
        COMMENT ‘Location and Administrative info for Boston Public Schools’ \
        ROW FORMAT DELIMITED \
        FIELDS TERMINATED BY ‘,’ \
        LINES TERMINATED BY ‘\n’ \
    ...
    "Public"*)
        echo "CREATE TABLE IF NOT EXISTS '$filename' ( ${params[0]} double, ${params[1]} double, ${params[2]} int, ${params[3]} int, ${params[4]} string, ${params[5]} string, ${params[6]} string, ${params[7]} int, ${params[8]} int, ${params[9]} int, ${params[10]} string, ${params[11]} string, ${params[12]} string, ${params[13]} string, ${params[14]} string ) \
        COMMENT ‘Location and Administrative info for Boston Public Schools’ \
        ROW FORMAT DELIMITED \
        FIELDS TERMINATED BY ‘,’ \
        LINES TERMINATED BY ‘\n’ \
